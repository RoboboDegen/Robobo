  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 bg-no-repeat bg-contain transition-none",
  {
    variants: {
      variant: {
        ...
        chat_back: "bg-[url('/gameui/chat/top_back_btn.png')] bg-center w-[120px] h-[40px]  text-right pl-2",
        inventory:
          "bg-[url('/gameui/home/bottom_btn.png')] hover:bg-[url('/gameui/home/bottom_btn_pre.png')] active:bg-[url('/gameui/home/bottom_btn_pre.png')] w-[120px] h-[60px] bg-center text-lg",
        fight: "bg-[url('/gameui/home/fight_button.png')] w-[120px] h-[60px] bg-center hover:bg-[url('/gameui/home/fight_button_click.png')] active:bg-[url('/gameui/home/fight_button_click.png')] text-lg",

        chat: "bg-[url('/gameui/home/chat_button.png')] w-[120px] h-[60px] bg-center hover:bg-[url('/gameui/home/chat_button_click.png')] active:bg-[url('/gameui/home/chat_button_click.png')] text-lg",
