  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 bg-no-repeat bg-contain transition-none",
  {
    variants: {
      variant: {
        ...
        mint_bottom:
          "bg-[url('/gameui/mint/bottom_bar_default.png')] w-[300px] hover:w-[300px] hover:bg-[url('/gameui/mint/bottom_bar_pre.png')] active:w-[300px] active:bg-[url('/gameui/mint/bottom_bar_pre.png')] h-[60px] text-[30px] bg-[length:300px_60px] bg-center",
      },
    },
    defaultVariants: {
      variant: "home_bottom",
